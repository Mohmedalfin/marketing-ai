...
export default function RegisterFormSection() {
  ...
  const handleNextStep = () => {
    if (!formData.username || !formData.email || !formData.password) {
      showNotification(
        "Silakan isi Username, Email, dan Password sebelum melanjutkan.",
        "error",
      );
      return;
    }
  ...
  return (
    ...
    >
        ...
        <div className="grid w-full grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-32 xl:gap-40">
          ...
          >
              ...
              {step === 1 && (
                <div className="flex flex-col gap-1 animate-in fade-in slide-in-from-left-4 duration-500">
                  <div className="flex flex-col">
                    <label
                      className="mb-1 text-sm font-bold text-primary"
                      htmlFor="username"
                    >
                      Username
                    </label>
                ...
                <div className="flex flex-col gap-3 animate-in fade-in slide-in-from-right-4 duration-500">
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    <label
                      ...
                      className="cursor-pointer text-xs text-gray-600 leading-snug"
                    >
            ...
            <p className="mt-4 text-center text-sm font-medium text-dark">
              ...
              <a
                href="/login"
                className="font-bold text-[#F98C23] hover:underline"
              >
                Login
              </a>
            </p>
          ...
          <div
            className={`hidden lg:flex w-full items-center justify-center transition-all duration-700 delay-400 ease-out
                        ${isVisible ? "translate-x-0 opacity-100" : "translate-x-12 opacity-0"}
                    `}
          >
            <img
      ...
      <ToastNotification
        ...
        type={notifType}
        positionClassName="top-6 sm:top-4"
      />
    </section>
  );
}
