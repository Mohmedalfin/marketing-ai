...
export const RefreshIcon = ({ isGenerating }: { isGenerating: boolean }) => (
...
export const DropdownArrowIcon = ({ isOpen, svgClass = "w-3 h-3" }: { isOpen: boolean, svgClass?: string }) => (
...
export const CaptionIcon = PhotoIcon; 
...
export const SpinnerIcon = ({ className = "animate-spin -ml-1 mr-2 h-5 w-5 text-white" }: { className?: string }) => (
